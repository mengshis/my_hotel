            ...
            <form class="layui-form">
                <table class="list-table">
                    ...
                    <tr>
                        ...
                        <td>${myOrder.oid}</td>
                        <td><a class="list-title" href="javascript:void(0)" feedback-id="9">${ myOrder.o_num}</a></td>
                        <td>${myOrder.uid}</td>
                        <td>${myOrder.r_id}</td>
                        <td>${myOrder.bookTime}</td>
                        <td>${myOrder.o_state}</td>
                        <td>${myOrder.o_quantity}</td>                    
                        <td style="text-align: center;width:143px">
                            <a href="toAddMyOrder.do" class="layui-btn layui-btn-warm layui-btn-small" title="添加"><i class="layui-icon"></i></a>
                            <a href="toEditMyOrder.do?oid=${ myOrder.oid}" class="layui-btn layui-btn-small" title="编辑"><i class="layui-icon"></i></a>
                            <a class="layui-btn layui-btn-small layui-btn-danger del_btn" feedback-id="${ myOrder.oid}" title="删除" feedback-name="${ room.r_name}"><i class="layui-icon"></i></a>
                        </td>
                    </tr>
                    </c:forEach>
                    </tbody>
