...
<div class="layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
        ...
        <a href="toEditRoom.do?r_id=${room.r_id }"><li class="layui-this">修改客房</li></a>
        <div class="main-tab-item">客房管理</div>
    </ul>
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <form method="post" class="layui-form" action="editRoom.do">
            <input type="hidden" name="r_id" value="${room.r_id }" 
								autocomplete="off" class="layui-input">
                <div class="layui-form-item">
                    <label class="layui-form-label">房间名称</label>
                    <div class="layui-input-block">
                        <input type="text" name="r_name" value="${room.r_name }" lay-verify="required" autocomplete="off" placeholder="请输入房名" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                		<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input type="phone" name="inStorey" value="${room.inStorey }" lay-verify="required"
									autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<select name="r_style_id" value="${room.r_style_id }">							        
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<select name="pic_id" value="${room.pic_id }">							        
						...
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<select name="h_id" value="${room.h_id }">							        
					...
					<div class="layui-form-item">
	                    ...
	                    <div class="layui-input-block">
	                        <input type="text" name="r_state" value="${room.r_state }" lay-verify="required" autocomplete="off" placeholder="请输入房间状态" class="layui-input">
	                    </div>
	                </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
