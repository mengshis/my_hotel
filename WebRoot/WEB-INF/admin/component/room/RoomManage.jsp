            ...
            <form class="layui-form">
                <table class="list-table">
                    ...
                    <tr>
                        ...
                        <td>${ room.r_id}</td>
                        <td><a class="list-title" href="javascript:void(0)" feedback-id="9">${  room.r_name}</a></td>
                        <td>${ room.inStorey}</td>
                        <td>${ room.r_style_id}</td>
                        <td>${ room.pic_id}</td>
                        <td>${ room.r_state}</td>
                        <td>${ room.h_id}</td>                       
                        <td style="text-align: center;width:143px">
                            <a href="toAddRoom.do" class="layui-btn layui-btn-warm layui-btn-small" title="添加"><i class="layui-icon"></i></a>
                            <a href="toEditRoom.do?r_id=${ room.r_id}" class="layui-btn layui-btn-small" title="编辑"><i class="layui-icon"></i></a>
                            <a class="layui-btn layui-btn-small layui-btn-danger del_btn" feedback-id="${ room.r_id}" title="删除" feedback-name="${ room.r_name}"><i class="layui-icon"></i></a>
                        </td>
                    </tr>
                    </c:forEach>
                    </tbody>
    ...
    layui.use(['element', 'laypage', 'layer', 'form'], function(){
        ...
        jq('.del_btn').click(function(){
            ...
            layer.confirm('确定删除【'+name+'】?', function(index){
                ...
                jq.post('delRoom.do',{'r_id':id},function(data){
