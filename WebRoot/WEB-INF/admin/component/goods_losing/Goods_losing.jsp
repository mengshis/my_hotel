...
<div class="layui-tab layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
        <div class="main-tab-item">物品管理</div>
    </ul>
        ...
        <div class="layui-tab-item layui-show">
            ...
            <form class="layui-form">
                <table class="list-table">
                    ...
                    <tbody>
                    <c:forEach var="goods_losing" items="${goods_losingList}">
                    <tr>
                        ...
                        <td>${ goods_losing.gid}</td>
                        <td><a class="list-title" href="javascript:void(0)" feedback-id="9">${  goods_losing.g_name}</a></td>
                        <td>${ goods_losing.g_price}</td>
                        <td>${ goods_losing.g_num}</td>
                        <td>${ goods_losing.g_total}</td>
                        <td>${ goods_losing.stayId}</td>                      
